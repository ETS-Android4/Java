...
public class UtilityRest {
     ...
     * @since 2020-06-21
     */
    public static void addUsingRest(String urlIn, PlantTracker planttracker) {
        //**********************************
        //Create a test plant entry
        //**********************************
        ...
        //************************************
        //convert the plant entry to a json string
        //************************************
        ...
        try {
            ...
            if (conn.getResponseCode() != HttpURLConnection.HTTP_CREATED) {
                ...
                PlantTracker entryReturned = gson.fromJson(content, PlantTracker.class);
                System.out.println("Success : Added entry (" + entryReturned.getId() + ")\n");
            }
            conn.disconnect();
        } catch (MalformedURLException e) {
            e.printStackTrace();
    ...
    public static void deleteUsingRest(String urlIn, int id) {
        ...
        try {
            ...
            if (conn.getResponseCode() != HttpURLConnection.HTTP_CREATED) {
                ...
                System.out.println("Success : deleted reflection (" + id + ")\n");
            }
            conn.disconnect();
        } catch (MalformedURLException e) {
            e.printStackTrace();
    ...
    /**
     * This method will access the booking service to update a booking
     *
     * @since 20200618
     * @author BJM
     * @modified Kendall Fowler - Sprint 4 Requirements
     * @since 2020-06-21
     */
     public static void updateUsingRest(String urlIn, PlantTracker planttracker) {
        ...
        try {
            ...
            if (conn.getResponseCode() != HttpURLConnection.HTTP_CREATED) {
                ...
                PlantTracker plantTrackerReturned = gson.fromJson(content, PlantTracker.class);
                System.out.println("Success : updated  entry (" + plantTrackerReturned.getId() + ")\n");
